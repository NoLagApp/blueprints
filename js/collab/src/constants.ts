...
export const DEFAULT_APP_NAME = 'collab';

/** Maximum number of operations to keep in the cache */
export const DEFAULT_MAX_OPERATION_CACHE = 1000;
...
export const DEFAULT_CURSOR_THROTTLE = 50;

/** Topic name for operation messages within a document */
export const TOPIC_OPERATIONS = 'operations';

/** Topic name for cursor presence messages within a document */
export const TOPIC_CURSORS = '_cursors';
